...
public class BacklogController {
    ...
    public Iterable<ProjectTask> getProjectBacklog(@PathVariable String backlog_pId, Principal principal) {
        return projectTaskService.findBacklogBypId(backlog_pId, principal.getName());
    }
